...
export enum SourceTLD {
    EiquijoteEs = "eiquijote.es",
    Empty = "",
    WWWAlbacetebalompieEs = "www.albacetebalompie.es",
}
...
export enum DisplayName {
    AcademiaQuijoteLandAlbacete = "Academia QuijoteLand Albacete",
    AlbaceteBalompie = "Albacete Balompie",
    CoconuDesign = "Coconu-Design",
    Im3DiAComunicación = "Im3diA comunicación",
    Lagahe = "Lagahe",
}

export enum Username {
    Albacetebalompie = "albacetebalompie",
    CoconuDesign = "coconu-design",
    Eiquijote = "eiquijote",
    Im3Diacomunicacion = "im3diacomunicacion",
    Lagahe = "Lagahe",
}
